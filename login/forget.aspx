<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forget.aspx.cs" Inherits="admin_forget" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Online Job Portal Admin Panel Category Flat Bootstrap Responsive Web Template | Home :: w3layouts</title>
	...
	<div class="registration_left">
		<h2>Admin Login</h2>
		 <div class="registration_form">
				...
				<div>
                    <asp:Button ID="btnlogin" runat="server" Text="Get Reset Password" OnClick="btnlogin_Click1"  />
